...
const Navbar = () => {
  ...
  const handleMouseEnter = () => {
    gsap.to(bellIconRef.current, { scale: 1.2, duration: 0.3 });
  };

  const handleMouseLeave = () => {
    gsap.to(bellIconRef.current, { scale: 1, duration: 0.3 });
  };
